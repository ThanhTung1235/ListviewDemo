...
namespace AgainUWP
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void Choose_Image(object sender, RoutedEventArgs e)
        {
            ...
            currentUploadUrl = await httpClient.GetStringAsync(APIHandles.GET_UPLOAD_URL);
        ...
        private async void Do_Submit(object sender, RoutedEventArgs e)
        {
            ...
            var response = httpClient.PostAsync(APIHandles.MEMBER_REGISTER, content);
            ...
            {
                ErrorsResponse errorsResponse = JsonConvert.DeserializeObject<ErrorsResponse>(contents);
